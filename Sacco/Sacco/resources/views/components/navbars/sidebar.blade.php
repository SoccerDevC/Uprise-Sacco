...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            ...
            <span class="ms-2 font-weight-bold text-white">UPRISE SACCO MENU</span>
        </a>
    </div>
    <hr class="horizontal light mt-0 mb-2">
    <div class="  w-auto  max-height-vh-100  bottom-0"   id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'user-management' ? ' active bg-gradient-primary' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">Group Management</span>
                </a>
            </li>
            <li class="nav-item mt-3">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'uploads' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('uploads') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'emails' ? ' active bg-gradient-primary' : '' }}  "
                    href="{{ route('emails') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">emails</i>
                    </div>
